...
# # Function to get job_id by sending a request to the process file endpoint
...
#     try:
#         response = requests.get(url, auth=HTTPBasicAuth('admin', 'fp_bol_ocr'))
...
#             # Step 1: Get the job_id by hitting the process file URL
#             with st.spinner('Processing the BOL image...'):
...
#                 # Step 2: Get the result by passing job_id to the result URL
